		...
		<div id="col-left"><div class="col-wrap"><div class="form-wrap">		
			...
			<div id="col-left"><div class="col-wrap"><div class="form-wrap">
				...
				<?php else : ?>
					...
					<div class="form-field form-required">
						<label for="name"><?php _e( 'Name', 'edit-flow' ); ?></label>
						<input type="text" aria-required="true" id="name" name="name" maxlength="40" value="
						<?php 
						if ( ! empty( $_POST['name'] ) ) {
	...
	class EF_Usergroups_List_Table extends WP_List_Table {
		...
		function column_name( $usergroup ) {
			...
			$output = '<strong><a href="' . esc_url(
				$edit_flow->user_groups->get_link(
					array(
						'action'       => 'edit-usergroup',
						'usergroup-id' => $usergroup->term_id,
					) 
			...
			$actions['edit edit-usergroup']     = sprintf(
				'<a href="%1$s">' . __( 'Edit', 'edit-flow' ) . '</a>',
				$edit_flow->user_groups->get_link(
					array(
						'action'       => 'edit-usergroup',
						'usergroup-id' => $usergroup->term_id,
			...
			$actions['delete delete-usergroup'] = sprintf(
				'<a href="%1$s">' . __( 'Delete', 'edit-flow' ) . '</a>',
				$edit_flow->user_groups->get_link(
					array(
