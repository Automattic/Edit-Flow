	...
	class EF_Editorial_Metadata extends EF_Module {
		...
		<?php else : ?>
			...
			<div class="form-field form-required">
				...
				<input type="text" aria-required="true" size="20" maxlength="200" id="metadata_name" name="metadata_name" value="
				<?php 
			...
			<div class="form-field form-required">
				...
				<input type="text" aria-required="true" size="20" maxlength="200" id="metadata_slug" name="metadata_slug" value="
				<?php 
			...
			<div class="form-field">
				...
				<textarea cols="40" rows="5" id="metadata_description" name="metadata_description">
				<?php 
...
class EF_Editorial_Metadata_List_Table extends WP_List_Table {
	...
	function column_name( $item ) {
		...
		if ( $item->viewable ) {
			$actions['change-visibility make-hidden'] = '<a title="' . esc_attr( __( 'Hidden metadata can only be viewed on the edit post view.', 'edit-flow' ) ) . '" href="' . esc_url(
				$edit_flow->editorial_metadata->get_link(
					array(
						'action'  => 'make-hidden',
						'term-id' => $item->term_id,
			...
			$actions['change-visibility make-viewable'] = '<a title="' . esc_attr( __( 'When viewable, metadata can be seen on views other than the edit post view (e.g. calendar, manage posts, story budget, etc.)', 'edit-flow' ) ) . '" href="' . esc_url(
				$edit_flow->editorial_metadata->get_link(
					array(
