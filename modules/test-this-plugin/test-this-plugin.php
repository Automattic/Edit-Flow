...
if(!class_exists('EF_Test_this_plugin')) {
    
class EF_Test_this_plugin extends EF_Module {
    
    private $module_name = 'test_this_plugin';
    ...
    public function __construct() {
        $this->module_url = $this->get_module_url( __FILE__ );
            ...
            $args = array(
                    'title' => __( 'Test this plugin', 'edit-flow' ),
                    ...
                    'img_url' => $this->module_url . 'lib/test_this_plugin\_s128.png',
                    'slug' => 'test-this-plugin',
    ...
    function register_settings() {
                    ...
                    add_settings_field( 'post_types', __( 'Add to these post types:', 'test-this-plugin' ), array( $this, 'settings_post_types_option' ), $this->module->options_group_name, $this->module->options_group_name . '_general' );
    }
    ...
    function add_admin_scripts() {
        wp_enqueue_style( 'edit_flow-test-this-plugin -styles', $this->module_url . 'lib/test-this-plugin.css', false, EDIT_FLOW_VERSION, 'all' );
    }
