...
class EF_Settings extends EF_Module {
	...
	function print_default_footer( $current_module ) {
		...
		<br /><?php prinf( __( 'You\'re using Edit Flow version %d.', 'edit-flow' ), EDIT_FLOW_VERSION ); ?>
		<br /><?php echo __( 'Icons courtesy of the <a href="http://thenounproject.com/">Noun Project</a>.' ); ?>
